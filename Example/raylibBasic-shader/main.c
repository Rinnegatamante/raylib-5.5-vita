...
int main(void)
{
    ...
    while (!WindowShouldClose())        // Detect window close button or ESC key
    {
        ...
        if (IsGamepadButtonPressed(gamepad, GAMEPAD_BUTTON_LEFT_FACE_RIGHT)) currentShader++;
        else if (IsGamepadButtonPressed(gamepad, GAMEPAD_BUTTON_LEFT_FACE_LEFT)) currentShader--;
