...
void TraceLog(int logType, const char *text, ...)
{
        ...
        if (traceLog)
        {
            ...
            switch (logType)
            {
                case LOG_INFO: sceClibPrintf("[INFO] : "); break;
                case LOG_ERROR: sceClibPrintf("[ERROR]: "); break;
                case LOG_WARNING: sceClibPrintf("[WARN] : "); break;
                case LOG_DEBUG: sceClibPrintf("[DEBUG]: "); break;
                default: break;
            }
            sceClibVprintf(text, args);
            sceClibPrintf("\n");
        #else
